...
const Hero = () => {
  ...
  const socialLinks = [
    { icon: FaLinkedin, url: "https://www.linkedin.com/in/thakur-basim0786", color: "bg-blue-600" },
    { icon: FaGithub, url: "https://github.com/BasimThakur", color: "bg-gray-800" },
    { icon: FaInstagram, url: "https://www.instagram.com/its_basim/", color: "bg-pink-600" },
  ];
    ...
    <section className="relative overflow-hidden bg-gradient-to-br from-gray-900 via-indigo-950 to-purple-900 py-16 md:py-0 min-h-screen flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 lg:px-8 py-12 flex flex-col md:flex-row items-center justify-between">
        ...
        >
          ...
          >
            <span className="text-indigo-300 text-sm font-medium">Frontend Developer</span>
          </motion.div>
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            I specialize in modern frontend development, crafting responsive websites and interactive user interfaces using React, Next.js, and Tailwind CSS. I focus on clean architecture, performance optimization, and seamless user experiences.
          </motion.p>
