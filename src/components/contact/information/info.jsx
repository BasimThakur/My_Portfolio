...
const ContactCard = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      id: "linkedin",
      icon: FaLinkedin,
      url: "https://www.linkedin.com/in/thakur-basim0786",
      color: "text-blue-400",
      hoverBg: "bg-blue-500",
      label: "LinkedIn",
    },
    {
      id: "github",
      icon: FaGithub,
      url: "https://github.com/BasimThakur",
    ...
    },
    {
      id: "instagram",
      icon: FaInstagram,
      url: "https://www.instagram.com/its_basim/",
      color: "text-pink-400",
      hoverBg: "bg-pink-500",
      label: "Instagram",
    },
  ...
  const contactInfo = [
    {
      icon: FaEnvelope,
      content: "basimthakur3@gmail.com",
      isLink: true,
      url: "mailto:basimthakur3@gmail.com",
      color: "text-indigo-300",
      label: "Email",
    },
    {
      icon: FaPhone,
      content: "+91 7218736825",
      isLink: false,
      color: "text-blue-300",
      label: "Phone",
    },
    {
      icon: FaMapMarkerAlt,
      content: "Seawoods(Nerul), Navi Mumbai",
      isLink: false,
            ...
            <div>
              ...
              <div className="mt-12 border-t border-indigo-500/20 pt-6">
                <p className="text-indigo-200/60 text-sm">
                  © {new Date().getFullYear()} | Basim Thakur
                </p>
              </div>
            </div>
          </div>
